...
DATABASES = {
    'default': {
        ...
        'NAME': 'watchTowerSpace',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'nolwen',                  # Not used with sqlite3.
...
SECRET_KEY = 'd9pd%&6e^#!sc4oc)h2kep0d686=42@hvf+2%ng6@k)_!hxk+c'
