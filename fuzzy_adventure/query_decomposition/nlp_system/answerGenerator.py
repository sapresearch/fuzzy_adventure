...
#definitions:
    ...
    if stemmed('productive') in allWords or stemmed('productive') in question:
		...
		conditions.update(set(conditions_temp))
		what.update(set(what_temp))
		# start_date = '45'
    ...
    if 'very high' in allWords or 'very high' in question:
		what.add('transaction')
		conditions_temp = 'Very high'
		conditions.add(conditions_temp)

    elif 'high' in allWords or 'high' in question:
		what.add('transaction')
		conditions_temp = 'High'
		conditions.add(conditions_temp)

    elif 'low' in allWords or 'low' in question:
		what.add('transaction')
		conditions_temp = 'Low'
		conditions.add(conditions_temp)

    elif 'medium' in allWords or 'medium' in question:
		what.add('transaction')
